...
s3_bucket = 'udacity-airflow-akinc'
...
load_user_dimension_table = SubDagOperator(
    subdag=load_dimension_subdag(
        ...
        sql_statement=Queries.user_table_insert,
        delete_load=True,
        table_name="users",
    ),
    task_id="Load_user_dim_table",
...
load_song_dimension_table = SubDagOperator(
    subdag=load_dimension_subdag(
        ...
        redshift_conn_id="redshift",
        start_date=default_args['start_date'],
        sql_statement=Queries.song_table_insert,
        delete_load=True,
        table_name="songs",
    ),
    task_id="Load_song_dim_table",
...
load_artist_dimension_table = SubDagOperator(
    subdag=load_dimension_subdag(
        ...
        redshift_conn_id="redshift",
        start_date=default_args['start_date'],
        sql_statement=Queries.artist_table_insert,
        delete_load=True,
        table_name="artists",
    ),
    task_id="Load_artist_dim_table",
...
load_time_dimension_table = SubDagOperator(
    subdag=load_dimension_subdag(
        ...
        redshift_conn_id="redshift",
        start_date=default_args['start_date'],
        sql_statement=Queries.time_table_insert,
        delete_load=True,
        table_name="time",
    ),
    task_id="Load_time_dim_table",
